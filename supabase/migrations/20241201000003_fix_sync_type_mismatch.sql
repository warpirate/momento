-- Fix type mismatch in sync functions
-- This migration fixes the COALESCE types text[] and jsonb cannot be matched error

-- Drop and recreate pull_changes function with consistent types
...
begin
  ...
  -- Pull signals with consistent type handling - convert arrays to jsonb
...
-- Drop and recreate push_changes function with consistent type handling
...
begin
  ...
  -- Process signals with proper type handling for arrays
