-- Migration: Add voice_note column to entries table
-- Date: 2025-12-03

-- ============================================================================
-- 1. ADD VOICE_NOTE COLUMN TO ENTRIES TABLE
-- ============================================================================
...
BEGIN
    IF NOT EXISTS (
        ...
        AND column_name = 'voice_note'
    ) THEN
        ALTER TABLE public.entries 
        ADD COLUMN voice_note text; -- Path to voice note file
...
-- Drop and recreate pull_changes function with voice_note support
...
BEGIN
  ...
  -- Pull entries (including voice_note)
...
-- Drop and recreate push_changes function with voice_note support
